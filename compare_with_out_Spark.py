...
def run_without():
    df = pd.read_csv('C:/Users/Khiem/Desktop/big_data/data/data1M_2.csv',header= None)    
    r,c = df.shape
...
# decision tree        
    ...
    print("thời gian chạy của cây quết định: ",end)
    print(" ")
...
# SVM
    ...
    print("thời gian chạy của SVM: ",end)
    print(" ")
...
# naive classifier
  ...
  #  model_navie = MultinomialNB()        
    ...
    print("thời gian chạy của Naive Bayes: ",end)
    print(" ")
...
# bagging
   ...
   # base_clas = GaussianNB()  
    ...
    print ("Bagging: ",acc)
    print("thời gian chạy của Bagging: ",end)  
    print(" ")
...
#random forest
    ...
    print("thời gian chạy của random forest: ",end)
    print(" ")
...
def run_with_spark():
    ...
    df= sc.textFile("C:/Users/Khiem/Desktop/big_data/data/data1M_2.csv").map(lambda line: line.split(","))
